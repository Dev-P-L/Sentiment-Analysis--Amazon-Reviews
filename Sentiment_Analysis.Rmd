...
IDs <- c("cart", "cart_tuned", "svm", "svm_tuned", "adaboost", "rf", 
         "gbm", "gbm_tuned", "xgb", "monmlp")
models <- c("CART",
           "CART",
...
knitr::kable(tab, "html", align = "c") %>% 
  ...
  row_spec(c(1, 3, 5:7, 9:10),  bold = T, 
           color = "#007ba7", background = "#9bc4e2") %>%
  row_spec(c(2, 4, 8), bold = T, color = "white", background = "#007ba7") 
rm(tab)
```
