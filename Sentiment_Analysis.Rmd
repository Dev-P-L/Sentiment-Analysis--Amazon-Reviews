...
kable(df, "html", align = "c") %>% 
  ...
  row_spec(c(1, 5, 9, 11, 12), bold = T, color = "white", 
           background = "purple") %>%
  row_spec(c(2, 3, 4, 6:7), bold = T, color = "white", background = "magenta") 
...
tab <- kable(tab, "html", align = "c") %>% 
  kable_styling(bootstrap_options = c("bordered", "condensed"), 
                full_width = F, font_size = 16) %>%
  row_spec(1:nrow(tab), bold = T, color = "white", background = "magenta") 
tab
rm(tab)
```
...
kable(df, "html", align = "c") %>% 
  ...
  row_spec(2:10, bold = T, color = "white", background = "#007ba7")
