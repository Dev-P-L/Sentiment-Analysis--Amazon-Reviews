...
## IV. MACHINE LEARNING SEARCH FOR ACCURACY ON THE TRAINING SET
...
## V. VALIDATION ON THE VALIDATION SET
...
rm(pred_xgb, pred_baseline, pred_cart_tuned, ref, tab)
```
...
https://books.google.be/books?id=GgmqDwAAQBAJ&pg=PA80&lpg=PA80&dq=in+train()+evaluating+accuracy+standard+error+with+results$accuracy+or+with+resample$accuracy
